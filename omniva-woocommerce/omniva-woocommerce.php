<?php
/**
 * Plugin Name: Vetfonds - Omniva shipping
 * Description: Vetfonds adaptation of Official Omniva shipping plugin for WooCommerce
 * Author: Omniva
...
define('OMNIVALT_VERSION', '1.20.10.1');
